...
export default function FollowingPosts() {
  ...
  useEffect(() => {
    const fetchFollowingPosts = async () => {
      try {
        ...
        const response = await axios.get("http://localhost:5000/my-following-post", {
          headers: {
  ...
  async function likePost(id: string) {
    try {
      ...
      const newData = followingPosts.map((post) => {
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent className="px-3 py-0 rounded-lg max-h-176 lg:max-w-240 lg:max-h-none">
                    ...
                    <div className="grid items-start lg:grid-cols-2 gap-x-4">
                      <div className="flex items-center p-2 mb-2 -mt-4 border border-gray-200 rounded-sm lg:hidden gap-x-4">
                        {post.postedBy.Photo ? (
                          <img
                            src={post.postedBy.Photo}
                            alt="profilepic"
                      ...
                      {/* right card */}
                      <div>
                        <div className="items-center hidden p-2 border border-gray-200 rounded-sm lg:flex gap-x-4">
                          {post.postedBy.Photo ? (
                            <img
                              src={post.postedBy.Photo}
                              alt="profilepic"
